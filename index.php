...
include "header.php";
$page = $_REQUEST["page"];
$query1 = "select * from pages where tag='main'";
...
<p align=center>
<input type="hidden" name="prospectgroup" value="MAIN">
...
<br>
<a href="http://demoautoresponderma.phpsitescripts.com/admin" target="_blank"><img src="http://phpsitescripts.com/images/demo.png" border="0"></a>
<br><br><br>
Please check out our interactive DEMO of the Autoresponder Admin Multilist Site Script as an admin <a href="http://demoautoresponderma.phpsitescripts.com/admin" target="_blank">HERE</a> (admin login details are already in the login form for you).</b><br><br>This script is for one user (the admin) to build a mailing list from people who submit the form above, not a membership site. The site owner can paste (and design) the form code to place it anywhere (his or her websites, emails, etc.)</b><br><br><br>
...
<tr><td colspan="2" align="center"><br><font size="6" color="ff0000">Buy This Autoresponder Admin Multilist Site Script Now For Only $99.00!</font></td</tr>
<form action="http://phpsitescripts.com/sales_order.php" method="post">
<tr><td align="right">Licence:</td><td>Single Site License for Autoresponder Admin Multilist Site Script</td></tr>
...
<input type="hidden" name="order_script" value="autoresponder_multilist_admin_v1.2">
