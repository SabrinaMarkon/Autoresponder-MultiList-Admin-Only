...
--
-- Host: localhost    Database: phpsites_demoautoresponderma
-- ------------------------------------------------------
...
CREATE TABLE `admin` (
  ...
  `title` varchar(255) NOT NULL DEFAULT 'The Place To Be At',
  `webmasteremail` varchar(255) NOT NULL DEFAULT '',
  `autoresponderemail` varchar(255) NOT NULL DEFAULT '',
  `redirecturl` varchar(255) NOT NULL DEFAULT '',
  `disclaimer` text NOT NULL,
  `disclaimerimports` text NOT NULL,
  `editpageshtmleditor` varchar(4) NOT NULL DEFAULT 'yes',
  PRIMARY KEY (`id`)
...
INSERT INTO `admin` (`id`, `username`, `password`, `domain`, `title`, `webmasteremail`, `autoresponderemail`, `redirecturl`, `disclaimer`, `disclaimerimports`, `editpageshtmleditor`) VALUES (1,'Admin','admin','http://demoautoresponderma.phpsitescripts.com','Autoresponder Admin Multilist Demo','sales@phpsitescripts.com','bounce@phpsitescripts.com','http://phpsitescripts.com','You are receiving this email because you recently opted in from our website form at: http://demoautoresponderma.phpsitescripts.com If you do not wish to receive any further mailings, please remove yourself with the below link which will delete your address completely from our system.','You are receiving this  email because you recently requested more information about making money  from home. If you do not wish to receive any further  mailings, please remove yourself with the below link which will delete  your address completely from our system.','yes');
...
CREATE TABLE `autoresponders` (
  ...
  `autorespondermessage` text NOT NULL,
  `autorespondersubject` varchar(255) NOT NULL DEFAULT '',
  `autoresponderfromfield` varchar(255) NOT NULL DEFAULT '',
  `autoresponderdays` int(10) unsigned NOT NULL DEFAULT '1',
  `sendtoprospectgroups` text NOT NULL,
...
INSERT INTO `pages` (`id`, `name`, `htmlcode`, `tag`) VALUES (1,'Main Page','test','main');
/*!40000 ALTER TABLE `pages` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `prospectgroups`
--

DROP TABLE IF EXISTS `prospectgroups`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `prospectgroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `prospectgroupname` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `prospectgroups`
--

LOCK TABLES `prospectgroups` WRITE;
/*!40000 ALTER TABLE `prospectgroups` DISABLE KEYS */;
INSERT INTO `prospectgroups` (`id`, `prospectgroupname`) VALUES (1,'MAIN');
/*!40000 ALTER TABLE `prospectgroups` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `prospects` (
  ...
  `prospectgroup` varchar(255) NOT NULL DEFAULT 'MAIN',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `prospects` (`id`, `firstname`, `lastname`, `email`, `phone`, `howfound`, `referringpage`, `day`, `prospectgroup`) VALUES (1,'Demo','Member','webmaster@pearlsofwealth.com','','TESTING','ADMIN IMPORT',0,'MAIN');
/*!40000 ALTER TABLE `prospects` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'phpsites_demoautoresponderma'
--

--
-- Dumping routines for database 'phpsites_demoautoresponderma'
--
...
-- Dump completed on 2015-04-30  9:49:11
