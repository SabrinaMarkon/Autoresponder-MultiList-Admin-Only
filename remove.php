...
include "./incs/db.php";
$r = $_REQUEST["r"];
$q1 = "select * from prospects where email=\"$r\"";
$r1 = mysql_query($q1);
...
while ($rowz1 = mysql_fetch_array($r1))
	{
$id = $rowz1["id"];
$q2 = "delete from prospects where email=\"$r\" or id=\"$id\"";
$r2 = mysql_query($q2);
	}
include "header.php";
?>
<!-- CONTENT //-->
<table cellpadding="4" cellspacing="0" border="0" width="75%" align="center">
<tr><td align="center" colspan="2"><br><div style="font-size: 18px; font-weight: bold; color: #FF0000; font-family: Verdana;">YOUR ADDRESS WAS REMOVED COMPLETELY FROM OUR SYSTEM</div></td></tr>
</table>
<!-- END CONTENT //-->
<?php
include "footer.php";
