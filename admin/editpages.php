...
$q = "update admin set editpageshtmleditor=\"$saveeditpageshtmleditor\"";
$r = mysql_query($q);
...
function changeHiddenInput(objDropDown)
{
	...
	{	
		...
		var objdeletepageid = document.getElementById("deletepageid");
		var objdeletepagename = document.getElementById("deletepagename");
		objpageid.value = pageid;
		objpagename.value = pagename;
		objdeletepageid.value = pageid;
		objdeletepagename.value = pagename;
		tinyMCE.getInstanceById('mce_editor_0').getBody().innerHTML=' ';
		tinyMCE.execCommand('mceInsertContent',false,pagehtmlcode);
	}
	else
	{
		var objpageid = document.getElementById("pageid");
		...
		objpageid.value = "";
		objpagename.value = "";
		objdeletepageid.value = "";
		objdeletepagename.value = "";
		tinyMCE.getInstanceById('mce_editor_0').getBody().innerHTML=' ';
	}
}
</script> 
